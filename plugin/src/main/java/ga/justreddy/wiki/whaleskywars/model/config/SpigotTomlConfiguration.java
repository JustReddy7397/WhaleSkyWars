 ...
 * @author JustReddy
 */
public abstract class SpigotTomlConfiguration extends TomlConfiguration {

    public SpigotTomlConfiguration(File file) {
        super(file);
    }

    public SpigotTomlConfiguration(String name) {
        super(name);
    }

    public SpigotTomlConfiguration(File folder, String path) {
        super(folder, path);
    }
